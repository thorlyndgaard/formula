...
- Format driver
  `nix --experimental-features "nix-command flakes" run git+https://git.seikm.com/Seikm/MansaOS#mansao-installer -- format --device "/dev/disk/by-id/ata-KINGSTON_SA400S37960G_50026B77853CCEF7" --swapFileSize "16G" --ephemeralEnable true --ephemeralType "btrfs" --mainPartitionSize "740G"`
